...
| `experiments/` | 27 training experiments (Phases 1-22c) with results, plus PyTorch cross-framework verification -- spectral persistence, progressive learning, harmonic decoding, wave packet engine, weight spectral analysis, harmonic attention, LC circuit layer, Kerr-ODE layer, per-band Kerr, inverse Kerr reversibility analysis, analytical L0 replacement, wider clamp analysis, and more |
