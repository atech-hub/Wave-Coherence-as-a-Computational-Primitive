...
| `experiments/` | 22 training experiments (Phases 1-20b) with results, plus PyTorch cross-framework verification -- spectral persistence, progressive learning, harmonic decoding, wave packet engine, weight spectral analysis, harmonic attention, LC circuit layer experiments, and more |
...
| `ENGINE-PATTERNS.md` | Defensive publication: 52 engine pattern families (170+ implementations) as prior art across computing, AI, healthcare, finance, aerospace, automotive, robotics, energy, quantum computing, analogue/neuromorphic hardware, and 15 other domains |
